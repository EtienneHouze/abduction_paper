...
% L'utilisation d'une mesure unique de la mémorabilité d'événements de natures et caracteristiques diverses 
% La mise en application pratique des notions théoriques de mémorabilité et mémorabilité relative nécessité des développements futurs. Dans cette section, nous en avons sélectionné 2 qui nous semblent, à ce jour, les plus préoccupants.
